 ...
 * @author Usuario
 */
public class JfrmAceptarPersonal extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmAceptarPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmAceptarPersonal().setVisible(true);
            }
        });
    }
