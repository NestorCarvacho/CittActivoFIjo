...
public class JfrmAgregarProductoMasivo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnAgregarALista.setText("Agragar a Lista");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmAgregarProductoMasivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
